...
<head>
    ...
    <title>Profesores Investigadores</title>
...
<?php
    foreach($list_infpfi as $Infpf){

        $idimg = $Infpf->getFotografia();
        ...
        printf('<div class="col">
                    <div class="card mb-3" style="max-width: 540px;">
                        <div class="row g-0">
                            <div class="col-md-4">');
                        printf('<img src="/Users/%s/Perfil/%s" class="card-img-top" alt="...">', $Infpf->getEmail(),$fotografia->getNombreArchivo());
                        printf('</div>
