...
function(b, a) {
    ...
    function p(r) {
        if (k(), "string" == typeof r && (r = document.querySelector(r)), r && "object" == typeof r && r.nodeType) {
            ...
            var E = q(D.height);
            return E !== !1 && (i.height = E + (w ? 0 : H + J)), i.innerWidth = i.width - (C + h), i.innerHeight = i.height - (H + J), i.outerWidth = i.width + u, i.outerHeight = i.height + F, i
        }
    }
        ...
        b.docReady(function() {
            ...
            j.forEach(function(r) {
                ...
                try {
                    ...
                    return void(c && c.error("Error parsing " + m + " on " + r.className + ": " + l))
                }
                var v = new g(r, p);
                k && k.data(r, h, v)
            })
...
function(b, a) {
    ...
    j.constructor = x, j._create = function() {
        ...
        var D = getComputedStyle(this.element),
            ...
            u = parseFloat(h),
            c = this.layout.size;
        l.indexOf("%") != -1 && (C = C / 100 * c.width), h.indexOf("%") != -1 && (u = u / 100 * c.height), C = isNaN(C) ? 0 : C, u = isNaN(u) ? 0 : u, C -= d ? c.paddingLeft : c.paddingRight, u -= f ? c.paddingTop : c.paddingBottom, this.position.x = C, this.position.y = u
    ...
    return j.removeTransitionStyles = function() {
        ...
        return y && parseFloat(this.layout.options.transitionDuration) ? (this.once("transitionEnd", function() {
            this.removeElem()
...
function(b, a) {
    "function" == typeof define && define.amd ? define("outlayer/outlayer", ["ev-emitter/ev-emitter", "get-size/get-size", "fizzy-ui-utils/utils", "./item"], function(c, e, d, f) {
        return a(b, c, e, d, f)
    ...
    z.extend(g, k.prototype), g.option = function(a) {
        ...
        var c = A(B);
        return c.defaults = z.extend({}, B.defaults), z.extend(c.defaults, a), c.compatOptions = z.extend({}, B.compatOptions), c.namespace = d, c.data = B.data, c.Item = A(y), z.htmlInit(c, d), q && q.bridget && q.bridget(d, c), c
    };
    var x = {
        ms: 1,
        s: 1000
...
function(b, a) {
    "function" == typeof define && define.amd ? define("isotope-layout/js/item", ["outlayer/outlayer"], a) : "object" == typeof module && module.exports ? module.exports = a(require("outlayer")) : (b.Isotope = b.Isotope || {}, b.Isotope.Item = a(b.Outlayer))
}(window, function(f) {
    function a() {
...
function(b, a) {
    "function" == typeof define && define.amd ? define("isotope-layout/js/layout-mode", ["get-size/get-size", "outlayer/outlayer"], a) : "object" == typeof module && module.exports ? module.exports = a(require("get-size"), require("outlayer")) : (b.Isotope = b.Isotope || {}, b.Isotope.LayoutMode = a(b.getSize, b.Outlayer))
}(window, function(f, a) {
    function b(e) {
...
function(b, a) {
    "function" == typeof define && define.amd ? define("masonry-layout/masonry", ["outlayer/outlayer", "get-size/get-size"], a) : "object" == typeof module && module.exports ? module.exports = a(require("outlayer"), require("get-size")) : b.Masonry = a(b.Outlayer, b.getSize)
}(window, function(d, a) {
    ...
    return c._resetLayout = function() {
        ...
        for (var l = this.options.horizontalOrder ? "_getHorizontalColPosition" : "_getTopColPosition", q = this[l](m, v), p = {
        ...
        for (var g = this._getOption("originTop"), f = (g ? p.top : p.bottom) + j.outerHeight, k = e; k <= x; k++) {
...
function(b, a) {
    "function" == typeof define && define.amd ? define(["outlayer/outlayer", "get-size/get-size", "desandro-matches-selector/matches-selector", "fizzy-ui-utils/utils", "isotope-layout/js/item", "isotope-layout/js/layout-mode", "isotope-layout/js/layout-modes/masonry", "isotope-layout/js/layout-modes/fit-rows", "isotope-layout/js/layout-modes/vertical"], function(d, f, e, h, g, c) {
        return a(b, d, f, e, h, g, c)
    }) : "object" == typeof module && module.exports ? module.exports = a(b, require("outlayer"), require("get-size"), require("desandro-matches-selector"), require("fizzy-ui-utils"), require("isotope-layout/js/item"), require("isotope-layout/js/layout-mode"), require("isotope-layout/js/layout-modes/masonry"), require("isotope-layout/js/layout-modes/fit-rows"), require("isotope-layout/js/layout-modes/vertical")) : b.Isotope = a(b, b.Outlayer, b.getSize, b.matchesSelector, b.fizzyUIUtils, b.Isotope.Item, b.Isotope.LayoutMode)
    ...
    var v = j.prototype;
    v._create = function() {
        this.itemGUID = 0, this._sorters = {}, this._getSorters(), k.prototype._create.call(this), this.modes = {}, this.filteredItems = this.items, this.sortHistory = ["original-order"];
